...
describe("NFTMarketplace", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should track feePercent and feeAccount of the nft collection", async function () {
  ...
  describe("Making marketplace items", function () {
    ...
    it("Should track newly created item, transfer NFT from sellet to marketplace and emit Offered event", async function () {
  ...
  describe("Purchasing marketplace items", function () {
    ...
    beforeEach(async function () {
      ...
      it("Should update item as sold, pay seller, transfer NFT to buyer, charge fees and emit a Bought event", async function () {
        ...
        // fetch items totoal price (market fees + item price)
